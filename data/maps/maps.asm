...
MapGroup_NewAreas:
	map ViridianForest, TILESET_FOREST, CAVE, VIRIDIAN_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
	map ViridianForestPewterGate, TILESET_GATE, GATE, ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestViridianGate, TILESET_GATE, GATE, ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
