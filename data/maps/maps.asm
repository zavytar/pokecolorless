...
MapGroup_Pewter:
	...
	map PewterMuseum1F, TILESET_HOUSE, INDOOR, PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMuseum2F, TILESET_HOUSE, INDOOR, PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestPewterGate, TILESET_GATE, GATE, ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Dungeons:
	map ViridianForest, TILESET_FOREST, CAVE, VIRIDIAN_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_NIGHT, FISHGROUP_SHORE

MapGroup_Indigo:
	map IndigoPlateau, TILESET_KANTO, TOWN, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
