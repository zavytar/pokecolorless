...
; Johto story events - Main Story Events
	...
	const EVENT_CLEARED_ROCKET_HIDEOUT ; EVENT_BATTLED_SCHOOL
	const EVENT_GOT_SECRETPOTION_FROM_PHARMACY ; EVENT_BATTLED_RED_ROUTE_22
	const EVENT_DAISY_AUX ;GOT_SS_TICKET_FROM_ELM
