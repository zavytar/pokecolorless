...
; Johto story events - Main Story Events
	const EVENT_OAK_OUT
	const EVENT_RED_OAKS_LAB
	const EVENT_GOT_EEVEE_FROM_OAK
	const EVENT_BATTLED_RED_OAKSLAB
	const EVENT_ROUTE_1_GOT_POTION
	const EVENT_VIRIDIAN_GRAMPS_GRUMPY
	const EVENT_VIRIDIAN_GRAMPS_OKAY
	const EVENT_RED_ROUTE_22
	const EVENT_BATTLED_RED_ROUTE_22
	const EVENT_CLEARED_ROCKET_HIDEOUT
	const EVENT_DAISY_AUX
	const EVENT_BOUGHT_MAGIKARP_AT_MT_MOON
	const EVENT_ROUTE_4_GUARD
	const EVENT_ROUTE_4_ROCKETS
	const EVENT_GOT_TM05_ROAR_AT_ROUTE_4
	const EVENT_USED_THE_CARD_KEY_IN_THE_RADIO_TOWER
	const EVENT_PEWTER_CITY_BADGE_CHECK
	const EVENT_GOT_TM46_THIEF_AT_MOUNT_MOON_B2F
...
; Kanto hidden items
	...
	const EVENT_MOUNT_MOON_B2F_NUGGET
...
; Trainer flags
; Swimmer F
	const EVENT_BEAT_SWIMMERF_LOUISE
	...
	const EVENT_BEAT_SWIMMERF_DIANA2
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_CHARLIE
	const EVENT_BEAT_BUG_CATCHER_ANTHONY
	...
	const EVENT_BEAT_BUG_CATCHER_WADE3  ; nugget bridge 1
	const EVENT_BEAT_BUG_CATCHER_DOUG2
...
; Johto people
	...
	const EVENT_OAKS_AIDE_IN_CERULEAN_POKEMON_CENTER
